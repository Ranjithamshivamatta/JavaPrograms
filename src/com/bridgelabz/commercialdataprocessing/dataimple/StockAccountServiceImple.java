package com.bridgelabz.commercialdataprocessing.dataimple;
...
public class StockAccountServiceImple implements StockAccountService {
	...
	public void createStockAccount() {
		...
		try {
			Object obj = parser.parse(new FileReader("E:\\JavaJ\\Bridgelab\\src\\com\\bridgalabz\\commercialdataprocessing\\model\\StockAccount.json"));
	...
	public void buy(String stockCompany, double sharePrice) {
		...
		double noOfShares = DataStructureProgramming.getdouble();
	...
	public void save() {
		...
		try {
			FileWriter file = new FileWriter("E:\\JavaJ\\Bridgelab\\src\\com\\bridgalabz\\commercialdataprocessing\\model\\StockAccount.json");
