package com.bridgelabz.inventorymanagement.dataimple;
...
import com.bridgelabz.inventorymanagement.model1.InventoryManagement;
import com.google.gson.Gson;

public class InventoryManagementServiceImple implements InventoryManagementService {
	...
	public InventoryManagementServiceImple() {
		fileRead();
		this.gson = new Gson();
	}
	...
	private void fileRead() {
		...
		try {
			FileReader reader = new FileReader("E:\\JavaJ\\Bridgelab\\src\\com\\bridgelabz\\inventorymanagement\\model1\\InventoryManagement.json");
	...
	private void writeInventoryToFile() {
		try {
			...
			FileWriter file = new FileWriter("E:\\JavaJ\\Bridgelab\\src\\com\\bridgelabz\\inventorymanagement\\model1\\InventoryManagement.json");
			file.write(json);
			file.flush();
		} catch (IOException e) {
			e.printStackTrace();
